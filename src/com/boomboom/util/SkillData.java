...
public final class SkillData {
    ...
    /**
     * Get the timer used for SkillData.
     *
    ...
    public int getPercentToNextLevel(final int index) {
        final int level = Skills.getRealLevel(index);
        ...
        if (xpTotal == 0)
            return 0;
        final int xpDone = Skills.getExperience(index) - Skills.getExperienceRequired(level);
